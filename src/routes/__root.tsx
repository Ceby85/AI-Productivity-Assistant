  ...
  head: () => ({
    meta: [
      ...
      { title: "Third Space Coffee — AI Productivity Business Outline" },
      {
        name: "description",
        content:
          "A South African coffee shop concept powered by an AI back-office assistant, built for the CAPACITI AI productivity project.",
      },
      { name: "author", content: "Third Space Coffee" },
      { property: "og:title", content: "Third Space Coffee — AI Productivity Business Outline" },
      {
        property: "og:description",
        content:
          "Business concept, AI assistant features, prompt engineering and responsible-AI safeguards.",
      },
